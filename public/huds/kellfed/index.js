const COLOR_CT = "rgba(120,0,255, 1.0)";
const COLOR_T = "rgba(255,92,0, 1.0)";
const COLOR_NEW_CT = "rgba(120,0,255, 1.0)";
const COLOR_NEW_T = "rgba(255,92,0, 1.0)";
...
function fillPlayer(player, nr, side, observed, phase, previously) {
  ...
  let gradient_single = "linear-gradient(to " + side.substr(8) + ", rgba(54,87,209,0) " + (100 - stats.health) + "%, " + alt_health_color + " " + (100 - stats.health) + "%)";
